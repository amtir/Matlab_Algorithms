...
%**************************************************************************
%//////////////////////////////////////////////////////////////////////////
%///// A.A.P : Algorithme d'adaptation paramétrique: M_V_R  ///////////////
%//////////////////////////////////////////////////////////////////////////
%///// Maximum de vraissemblance récursif   ///////////////////////////////
%//////////////////////////////////////////////////////////////////////////
%//////////////////////////////////////////////////////////////////////////
%///// FILTRE NUMERIQUE NON-STATIONAIRE, paramètres adaptatifs ////////////
%///// FILTRE A MEMOIRE LIMITEE ///////////////////////////////////////////
%///// Estimation des paramètres du modèle ARMAX: A(z)Y(k)=B(Z)U(k)+C(z)e(k)
%///// une variable explicative U=P(précipitation)  ///////////////////////
%///// la sortie est le débit Q, d'ordre ARMAX(na,nb,nc,nk)////////////////
...
%//////////////////////////////////////////////////////////////////////////
% REFERENCE: Ioan D Landau, Identification des systèmes
%                           Paris, Hermès Science publication 2001
%**************************************************************************
...
%********************************************************
%// Maximum de vraisemblance récursif (M_V_R)
%********************************************************
%// Estimation du polynome C
C(1:nc+1)=1;
...
%*******************************************************
%//////////////////////////////////////////////////////////////////   
yh(i)=((Ph')')*Teta;  %// Estimation à prioiri
%/// Estimation des parametres d'ajustement (Teta) du modele ARX
e(i)=[Q(i)-((Ph')')*Teta]/[1+((Ph')')*Pm*(Ph')]; %//  Prendre l'erreur à postériori --> meilleur convergence!!!
...
e(i)=filter(1,C2,e(i));  %// Erreur filtrée
Q(i)=filter(1,C2,Q(i));  %// Vecteur d'observation filtré
P(i)=filter(1,C2,P(i));  %// Vecteur d'observation filtré
waitbar(g/((N1(2)-N1(1))))
...
legend('Débit mesuré','Débit prédit (MVR)') ;
