...
%// la sortie est le débit Q, d'ordre ARX(na,nb,nk), par exemple na=5 
%//  nb=5, nk=0//////////////////////////////////////////////////////
%// A(z)Y(k)=B(Z)U(k)+e(k) /////////////////////////////////////////////////
%///// Periode de prevision N1=[N1(1), N1(2)] // N1(1)> 350 ////////////////
%//////////// nk est le retard de la variable explictive////////////////////
%/////////// 0.98<Lamda<0.99 est le facteur d'oubli ////////////////////////
%**************************************************************************
%//////////////////////////////////////////////////////////////////////////
%// Modele ARX, AR, X à paramètres Adaptatifs ///////////////
%//////////////////////////////////////////////////////////////////////////

function MMCRP_Matlab

%N1=[800,1500]; na=5, nb=5,nk=0, Lamda=1;
%**************************************************************************
...
[yh,A]=AlgorMiseAJour_Matlab(N1,P,Q,na,nb,nk,Pm,Teta,Lamda);
%//////////////////////////////////////////////////////////////////////////
...
function [yh,A]=AlgorMiseAJour_Matlab(N1,P,Q,na,nb,nk,Pm,Teta,Lamda)

nn = [na nb nk];
z=[Q(N1(1):N1(2)),P(N1(1):N1(2))];
[thm,yh,P] = rarx(z,nn,'ff',Lamda,Teta,Pm);
figure,plot(thm);
figure,plot((N1(1):N1(2)),yh);
hold on, plot((N1(1):N1(2)),Q(N1(1):N1(2)),'r');
A=thm';
yh(N1(1):N1(2))=yh;
%yh=yh';
