...
fen=(30*24);  %// fenetre de 30 jours (1 mois) à gauche et à droite
%// Nombre d'année dans l'historique
for k=1:100
 debut= la_date-(k*365*24)-fen;
 %debut
 if ((debut <= 10)&((la_date-((k-1)*365*24)-fen)>=10)|(debut==0))  %S'assurer que les données existent
     (la_date-((k-1)*365*24)-fen);  
